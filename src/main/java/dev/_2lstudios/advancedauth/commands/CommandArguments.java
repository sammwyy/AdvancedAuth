...
import dev._2lstudios.advancedauth.players.OfflinePlayer;
import dev._2lstudios.advancedauth.utils.BukkitUtils;
...
public class CommandArguments {
    ...
    public CommandArguments(AdvancedAuth plugin, Argument[] requiredArguments) {
        this.plugin = plugin;
    ...
    public AuthPlayer getPlayer(int index) {
        if (!this.hasIndex(index)) return null;
        return (AuthPlayer) this.arguments.get(index);
    }
