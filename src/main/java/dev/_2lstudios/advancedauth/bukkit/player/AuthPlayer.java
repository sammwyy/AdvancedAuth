...
import dev._2lstudios.advancedauth.bukkit.utils.ArrayUtils;
import dev._2lstudios.advancedauth.bukkit.utils.PlaceholderUtils;
...
public class AuthPlayer extends PluginPlayer {
    ...
    public void fetchUserData() {
        ...
        boolean isGuestEnabled = this.plugin.getMainConfig().getBoolean("authentication.is-register-optional");
